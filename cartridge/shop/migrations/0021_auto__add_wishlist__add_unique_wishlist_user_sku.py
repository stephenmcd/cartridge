...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Wishlist', fields ['user', 'sku']
        db.create_unique('shop_wishlist', ['user_id', 'sku'])


    def backwards(self, orm):
        # Removing unique constraint on 'Wishlist', fields ['user', 'sku']
        db.delete_unique('shop_wishlist', ['user_id', 'sku'])
    ...
    models = {
        ...
        'shop.wishlist': {
            'Meta': {'unique_together': "(('user', 'sku'),)", 'object_name': 'Wishlist'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sku': ('cartridge.shop.fields.SKUField', [], {'max_length': '20'}),
