...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_product', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='products', to=orm['auth.User']),
                      keep_default=False)
    ...
    models = {
        ...
        'shop.product': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'products'", 'to': "orm['auth.User']"})
        },
        'shop.productaction': {
