...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductImage._order'
        db.alter_column(u'shop_productimage', '_order', self.gf('mezzanine.core.fields.OrderField')(null=True))

        # Changing field 'ProductVariation.image'
        db.alter_column(u'shop_productvariation', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.ProductImage'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'ProductImage._order'
        db.alter_column(u'shop_productimage', '_order', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ProductVariation.image'
        db.alter_column(u'shop_productvariation', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.ProductImage'], null=True))
    ...
    models = {
        ...
        u'shop.productvariation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shop.ProductImage']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'num_in_stock': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
