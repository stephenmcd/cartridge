...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ProductVariation', fields ['sku']
        db.create_unique('shop_productvariation', ['sku'])


        # Changing field 'Product.sku'
        db.alter_column('shop_product', 'sku', self.gf('cartridge.shop.fields.SKUField')(max_length=20, unique=True, null=True))
        # Adding unique constraint on 'Product', fields ['sku']
        db.create_unique('shop_product', ['sku'])


    def backwards(self, orm):
        # Removing unique constraint on 'Product', fields ['sku']
        db.delete_unique('shop_product', ['sku'])

        # Removing unique constraint on 'ProductVariation', fields ['sku']
        db.delete_unique('shop_productvariation', ['sku'])


        # Changing field 'ProductVariation.sku'
        db.alter_column('shop_productvariation', 'sku', self.gf('cartridge.shop.fields.SKUField')(default=0, max_length=20))

        # Changing field 'Product.sku'
        db.alter_column('shop_product', 'sku', self.gf('cartridge.shop.fields.SKUField')(default=0, max_length=20))
